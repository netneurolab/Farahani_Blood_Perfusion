...
Build a GLM model to quantify the effects of age and sex in the HCP developmental dataset

The cleaned data is saved as:
    Dev_perfusion_clean_sex_age.npy

We also save the beta coefficients and p-values for age and sex as:
    Dev_betas_age_perfusion.npy and Dev_betas_age_perfusion.dscalar.nii
    Dev_betas_sex_perfusion.npy and Dev_betas_sex_perfusion.dscalar.nii

    Dev_p_values_age_corrected_perfusion.npy and Dev_p_values_age_corrected_perfusion.dscalar.nii
    Dev_p_values_sex_corrected_perfusion.npy and Dev_p_values_sex_corrected_perfusion.dscalar.nii

Note: Related to Fig.4b & Fig.S12.
...
np.save(path_results + 'Dev_perfusion_clean_sex_age.npy', residuals)
...
#------------------------------------------------------------------------------
# save the results as a .dscalar.nii file (CIFTI) and also as a npy file
#------------------------------------------------------------------------------

save_as_dscalar_and_npy(betas_age,
                        'cortex_subcortex',
                        path_results,
                        'Dev_betas_age_perfusion')

save_as_dscalar_and_npy(betas_sex,
                        'cortex_subcortex',
                        path_results,
                        'Dev_betas_sex_perfusion')

save_as_dscalar_and_npy(p_values_sex_corrected,
                        'cortex_subcortex',
                        path_results,
                        'Dev_p_values_sex_corrected_perfusion')

save_as_dscalar_and_npy(p_values_age_corrected,
                        'cortex_subcortex',
                        path_results,
                        'Dev_p_values_age_corrected_perfusion')
