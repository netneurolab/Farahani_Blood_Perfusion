...
Non-linear trajectory of blood perfusion (for each Schaefer parcel) in HCP-Aging dataset.

Note: Related to Fig.S18b.
...
for i in range(nnodes):
    for label, sex_code in [('Male', 'M'), ('Female', 'F')]:
        ...
        try:
            ...
            if label == 'Male':
                r2_men[i] = r_squared_mu
                mu_fits_men[i] = mu_fitted  # dictionary assignment
            else:
                r2_women[i] = r_squared_mu
...
fig.tight_layout()
fig.savefig(path_figures + 'aging_r2_yeo_significance.svg', dpi=300)
...
fig_male.savefig(path_figures + 'aging_male_galss.svg', dpi=300)
fig_female.savefig(path_figures + 'aging_female_galss.svg', dpi=300)
...
# Create subplots
fig_male_grid, axes_male = plt.subplots(3, 3, figsize=(15, 10))
fig_female_grid, axes_female = plt.subplots(3, 3, figsize=(15, 10))
...
fig_male_grid.savefig(path_figures + 'aging_subplot_male_yeo.svg', dpi=300)
fig_female_grid.savefig(path_figures + 'aging_subplot_female_yeo.svg', dpi=300)
