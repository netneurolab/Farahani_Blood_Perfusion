...
# Calculate Functional Connectivity for Subjects with Perfusion Data - HCP Development

This script computes the functional connectivity (FC) for subjects within the HCP Development dataset who have associated perfusion data.
...
**Note**
- **HCP-Development dataset structure:**
    - **Subjects Older Than 7 Years:**
        - Have **4 runs** *provided their data is complete.
    - **Subjects Younger Than 7 Years:**
        - Have **6 scans** if their data is complete.
...
def process_subject(subid, labels):
    path_timeseries = f'/media/afarahani/Expansion/dev_fmri/{subid}_V1_MR/MNINonLinear/Results/'
    files = [
        ...
        'rfMRI_REST2_PA/rfMRI_REST2_PA_Atlas_MSMAll_hp0_clean.dtseries.nii',
         ...
         # Subjects aged 5-7 years old have 6 short fMRI scans instead of 4!
        'rfMRI_REST1a_AP/rfMRI_REST1a_AP_Atlas_MSMAll_hp0_clean.dtseries.nii',
        'rfMRI_REST1b_PA/rfMRI_REST1b_PA_Atlas_MSMAll_hp0_clean.dtseries.nii',
        'rfMRI_REST1a_PA/rfMRI_REST1a_PA_Atlas_MSMAll_hp0_clean.dtseries.nii',
        'rfMRI_REST2a_AP/rfMRI_REST2a_AP_Atlas_MSMAll_hp0_clean.dtseries.nii',
        'rfMRI_REST2a_PA/rfMRI_REST2a_PA_Atlas_MSMAll_hp0_clean.dtseries.nii',
        'rfMRI_REST2b_AP/rfMRI_REST2b_AP_Atlas_MSMAll_hp0_clean.dtseries.nii']
    ...
    FC = np.corrcoef(data)
    np.save(path_FC + 'Dev_FC_' + subid + '.npy', FC)
...
for s, subid in enumerate(subject_ids):
    print(s)
    path_timeseries = path_mri + 'dev_fmri/' + subid + '_V1_MR/MNINonLinear/Results/'
