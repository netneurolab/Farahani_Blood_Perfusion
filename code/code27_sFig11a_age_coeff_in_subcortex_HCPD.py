...
Subcortical age coeff (linear effect) for HCP-D dataset.

Note: Related to Fig.S11a.
...
#------------------------------------------------------------------------------
# Load age beta values for HCP-D
#------------------------------------------------------------------------------

map_data = np.load( path_results + 'Dev_betas_age_perfusion.npy')
...
plt.tight_layout()
plt.savefig(path_figures + 'age_beta_development_subcortex.svg',
            format = 'svg')
plt.show()
